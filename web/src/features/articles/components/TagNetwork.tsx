...
/* eslint-disable react-hooks/immutability -- force-directed simulation mutates ref-held node objects in place and drives itself via a recursive rAF callback */
