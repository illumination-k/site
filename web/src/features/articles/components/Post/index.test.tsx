  ...
  it("renders the title, MdxView, and the JSON-LD block", () => {
    render(
      <Post
        ...
        headings={headings}
        prefix="ja/techblog"
        canonicalUrl="https://illumination-k.dev/ja/techblog/post/00000000-0000-4000-8000-000000000000"
        ogImageUrl="https://illumination-k.dev/og/techblog/00000000-0000-4000-8000-000000000000.png"
        relatedPostMeta={[]}
        compiledMarkdown=""
        dict={jaDict}
      />,
