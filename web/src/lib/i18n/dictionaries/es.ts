...
const es: Dictionary = {
  ...
  profile: {
    ...
    biography: "Biografía",
    biographyParagraphs: [
      "illumination-k (Shogo Kawamura) trabaja en ingeniería de software y bioinformática. Cursó la licenciatura en Agronomía y el doctorado en Biociencias en la Universidad de Kioto (2023), con una beca de investigación de la JSPS entre 2021 y 2023.",
      ...
      "Desde 2023 trabaja en Preferred Networks en ingeniería de software y sigue colaborando en proyectos de genómica de hepáticas. Publica artículos sobre Rust, Python, desarrollo front-end y bioinformática en illumination-k.dev.",
    ],
    employment: "Empleo",
    education: "Educación",
