...
const ja: Dictionary = {
  ...
  profile: {
    ...
    biographyParagraphs: [
      "Shogo Kawamura は、分子生物学とバイオインフォマティクス、およびソフトウェアエンジニアリングを専門とする。京都大学農学部を卒業後、同大学院生命科学研究科で分子生物学を専攻し、2023年に博士号を取得した。博士課程在学中は日本学術振興会特別研究員（DC2、2021年〜2023年）に採用され、科研費「陸上植物における植物ホルモン・ジベレリンを介した生殖細胞分化機構の解明」（課題番号21J15550）に取り組んだ。",
