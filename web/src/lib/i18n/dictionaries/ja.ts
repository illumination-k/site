...
const ja: Dictionary = {
  ...
  profile: {
    ...
    biographyParagraphs: [
      ...
      "2023年より Preferred Networks でリサーチャー／エンジニアとして機械学習に関する研究開発に従事するかたわら、ゼニゴケ類のゲノム解析プロジェクトにも共同研究者として参加を続けている。本サイトでは、Rust、Python、フロントエンド開発、バイオインフォマティクスに関する記事を日本語と英語を中心に公開している。",
    ],
    employment: "職歴",
    education: "学歴",
    publications: "論文",
