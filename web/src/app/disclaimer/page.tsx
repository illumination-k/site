...
const JA_TEXT = {
  [`免責事項`]: `当サイトからのリンクやバナーなどで移動したサイトで提供される情報、サービス等について一切の責任を負いません。
...
const EN_TEXT = {
  [`Disclaimer `]: `I am not responsible for any information, services, etc. provided on sites to which you are redirected by links, banners, etc. from this site.
