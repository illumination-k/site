...
- **posts/** — Blog content. `techblog/{lang}/{category}/*.md` (ja/en/es, categories like `development`, `rust`, `python`, `bioinformatics`, …), `paperStream/` (Notion exports), `public/` (images + OG images source assets).
